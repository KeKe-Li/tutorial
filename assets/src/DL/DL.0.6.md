...
而自编码器的目的是，让输出尽可能复现输入x，即但是，这样问题就来了——如果f和g都是恒等映射，那不就恒有<img width="100" align="center" src="../../images/376.jpg" />了？不错，确实如此，但这样的变换——没有任何卵用啊！因此，我们经常对中间信号y（也叫作“编码”）做一定的约束，这样，系统往往能学出很有趣的编码变换f和编码y。
