...
给定d维空间中包含N个点的数据集、参数N（孤立点个数）和k（偏差距离）,如果满足<img width="50" align="center" src="../../images/55.jpg" />的点<img width="50" align="center" src="../../images/53.jpg" />不超过n-1个,那么称p为<img width="50" align="center" src="../../images/54.jpg" />孤立点。
