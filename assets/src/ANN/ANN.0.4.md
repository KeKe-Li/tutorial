...
当然，这个模型存在致命的问题：它的复杂度会爆炸性增长，<img width="200" align="center" src="../../images/292.jpg" />隐马尔科夫模型（HMM）定义每个元素只和离它最近的kk个元素相关，解决了复杂度暴增的问题，模型为:

<p align="center">
<img width="200" align="center" src="../../images/293.jpg" />
</p>

当k=1时，模型变为:
<p align="center">
<img width="200" align="center" src="../../images/294.jpg" />
</p>
...
<p align="center">
<img width="200" align="center" src="../../images/295.jpg" />
</p>
